...
def login(page):
    ...
    # Footer Account 선택
    page.locator('ion-label', has_text="Account").click()

    page.wait_for_timeout(1000)  # 1초 대기

    # App 배너 닫기
    page.locator_popup('a.close-get-app-bnr', has_text="close").click()
    ...
    username_input.fill(mo_username)
    password_input = page.locator('input[formcontrolname="password"]')
    password_input.fill(mo_password)
    ...
    # Free Shipping 팝업 닫기
    page.locator_popup('span.icon_close').click()